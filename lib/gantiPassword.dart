        ...
        children: [
          ...
          Row(
            children: [
              ...
              SizedBox(width: 5,),
              Text("Ganti Password", style: TextStyle(color: Colors.blue, fontSize: 25, fontWeight: FontWeight.bold),),
            ],
          ),
          SizedBox(height: 20),
          ...
          Padding(
            ...
            child: Text(
              ...
              "untuk mengganti password akun Anda. "
              "Ikuti instruksi yang\ndiberikan untuk memastikan "
              "bahwa password baru Anda\nberhasil disimpan "
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      ...
                      SizedBox(height: 5),
                      Text("2. Lalu isi field Password baru", style: TextStyle(fontSize: 15, color: Colors.grey[800]), ),
                      SizedBox(height: 5),
